...
open_kitty(){
  # Define variables
  local KEYBINDING_NAME="Kitty Terminal"
  local KEYBINDING_COMMAND="kitty"
  local KEYBINDING_BINDING="<Super>Return"
  ...
  info "Custom shortcut set: $KEYBINDING_BINDING will launch $KEYBINDING_NAME"
}
